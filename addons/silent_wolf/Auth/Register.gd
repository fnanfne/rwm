...
func _on_UsernameToolButton_mouse_entered() -> void:
	...
	$"FormContainer/MainFormContainer/InfoBox".text = "Username should contain at least 6 characters (letters or numbers) and no spaces."
	#$"FormContainer/InfoBox".show()
	$"FormContainer/MainFormContainer/InfoBox".show()


func _on_UsernameToolButton_mouse_exited() -> void:
	#$"FormContainer/InfoBox".hide()
	$"FormContainer/MainFormContainer/InfoBox".hide()
...
func _on_PasswordToolButton_mouse_entered() -> void:
	...
	$"FormContainer/MainFormContainer/InfoBox".text = "Password should contain at least 8 characters including uppercase and lowercase letters, numbers and (optionally) special characters."
	#$"FormContainer/InfoBox".show()
	$"FormContainer/MainFormContainer/InfoBox".show()
